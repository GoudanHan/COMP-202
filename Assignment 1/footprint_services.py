...
# calculoate foot print from monthly gas use
def fp_from_gas(monthly_gas):
    ...
    1.1907
    '''
    gas = kg_to_tonnes(pound_to_kg(monthly_gas*105))
    return gas



# calculoate foot print from daily hydro
def fp_from_hydro(daily_hydro):
    ...
    0.0107
    '''
    hydro = kg_to_tonnes(daily_to_annual(daily_hydro)/1000*0.6)
    return hydro


# calculoate the total foot print from utilities
def fp_of_utilities(daily_hydro, monthly_gas):
    ...
    0.9635
    '''
    utilities = fp_from_hydro(daily_hydro)+fp_from_gas(monthly_gas)
    return utilities
...
# calculoate foot print from annual credits
def fp_of_studies(annual_uni_credits):
    ...
    0.672
    '''
    studies = annual_uni_credits/30*1.12
    return studies
